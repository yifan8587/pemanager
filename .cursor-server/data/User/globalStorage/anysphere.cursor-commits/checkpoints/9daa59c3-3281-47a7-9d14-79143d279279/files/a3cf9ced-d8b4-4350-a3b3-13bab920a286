...
const routes = [
  ...
  {
    path: '/resourcemanage/inbound-sync',
    name: 'resource-inbound-sync',
    component: () => import('../views/resource/ResourceInboundSync.vue'),
    meta: { title: '资源回写' },
  },
  ...
  {
    path: '/interfacemanage/db-mirror',
    name: 'iface-db-mirror',
    component: () => import('../views/interface/InterfaceDbMirror.vue'),
    meta: { title: '配置镜像库' },
  },
  {
    path: '/interfacemanage/sources',
    name: 'iface-sources',
    component: () => import('../views/interface/InterfaceSources.vue'),
    meta: { title: '原始采集' },
  },
  {
  ...
  { path: '/routemanage', redirect: '/routemanage/desired-routes' },
  {
    path: '/routemanage/desired-routes',
    name: 'route-desired',
    component: () => import('../views/route/RouteDesired.vue'),
    meta: { title: '静态路由' },
  },
  ...
  { path: '/operationmanage', redirect: '/operationmanage/tools' },
  {
