...
export const qosApi = {
  ...
  summary: () => http.get('/api/qosmanage/summary/').then((r) => r.data),

  listPolicies: (params) =>
    http.get('/api/qosmanage/policies/', { params }).then((r) => unwrapList(r.data)),
  ...
  applyPolicy: (id, payload = {}) =>
    http.post(`/api/qosmanage/policies/${id}/apply-system/`, payload),
